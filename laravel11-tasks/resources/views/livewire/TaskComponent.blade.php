                        ...
                        <div class="flex justify-center">
                            <div x-data="{ isOpen: false }" class="relative flex justify-center gap-x-2.5">
                                @if((isset($task) && $task->permission == 'edit') || (auth()->user()->id == $task->user_id))
                                    ...
                                    <button @click="isOpen = true" class="px-3 py-1 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-yellow-700 rounded-lg hover:bg-orange-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                                        Compartir
                                    </button>
